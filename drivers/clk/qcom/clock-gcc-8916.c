...
static struct pll_freq_tbl apcs_pll_freq[] = {
	...
	F_APCS_PLL(1785600000, 95, 0x0, 0x1, 0x0, 0x0, 0x0),
	PLL_F_END
};
...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_650_clk[] = {
	F(  19200000,	      xo,   1,	  0,	0),
...
static struct rcg_clk gfx3d_clk_src = {
	...
	.set_rate = set_rate_hid,
	.freq_tbl = ftbl_gcc_oxili_gfx3d_650_clk,
	.current_freq = &rcg_dummy_freq,
	.base = &virt_bases[GCC_BASE],
	.c = {
...
static void gcc_gfx3d_fmax(struct platform_device *pdev)
{
	...
	gfx3d_clk_src.freq_tbl = ftbl_gcc_oxili_gfx3d_650_clk;
}
